...
" Set the background. Not entirely sure what this does
set background=dark " or light
" Clear the syntax highlight to its default state
highlight clear
if exists("syntax_on")
	syntax reset
endif
...
hi LineNr       guifg=white		guibg=#333333	gui=none 
